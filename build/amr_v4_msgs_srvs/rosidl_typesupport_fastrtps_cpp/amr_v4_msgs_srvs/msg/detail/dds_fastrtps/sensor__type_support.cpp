...
#include "amr_v4_msgs_srvs/msg/detail/sensor__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const amr_v4_msgs_srvs::msg::Sensor *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<amr_v4_msgs_srvs::msg::Sensor *>(
    untyped_ros_message);
...
{
  return &amr_v4_msgs_srvs::msg::typesupport_fastrtps_cpp::_Sensor__handle;
}
