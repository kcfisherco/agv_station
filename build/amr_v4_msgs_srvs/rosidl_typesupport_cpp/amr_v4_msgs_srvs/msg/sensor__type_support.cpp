...
static const _Sensor_type_support_symbol_names_t _Sensor_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, amr_v4_msgs_srvs, msg, Sensor)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, amr_v4_msgs_srvs, msg, Sensor)),
  }
};
...
{
  return &::amr_v4_msgs_srvs::msg::rosidl_typesupport_cpp::Sensor_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, amr_v4_msgs_srvs, msg, Sensor)() {
  return get_message_type_support_handle<amr_v4_msgs_srvs::msg::Sensor>();
}
