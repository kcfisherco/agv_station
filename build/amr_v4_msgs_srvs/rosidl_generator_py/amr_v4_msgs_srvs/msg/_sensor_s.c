...
bool amr_v4_msgs_srvs__msg__sensor__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("amr_v4_msgs_srvs.msg._sensor.Sensor", full_classname_dest, 35) == 0);
  }
  amr_v4_msgs_srvs__msg__Sensor * ros_message = _ros_message;
  {  // status
...
PyObject * amr_v4_msgs_srvs__msg__sensor__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("amr_v4_msgs_srvs.msg._sensor");
